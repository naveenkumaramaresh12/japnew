                                        ...
                                        <div className="bd-contact__item">
                                            <div className="bd-contact__item-list">
                                                ...
                                                <div className="bd-contact__content">
                                                    ...
                                                    <span>Mobile : <a href="tel:(+88)872-670-780"><span>080 - 26561151
</span></a></span>
                                                    <span>Mobile : <a href="tel:(+8)422-655-793"><span>080 - 26561152
</span></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="bd-contact__item">
                                            <div className="bd-contact__item-list">
                                                ...
                                                <div className="bd-contact__content">
                                                    ...
                                                    <span><a href="mailto:info@iccoa.org">info@jap.bio</a></span>
                                        ...
                                        <div className="bd-contact__item">
                                            <div className="bd-contact__item-list">
                                                ...
                                                <div className="bd-contact__content">
                                                    ...
                                                    <p>Jaivik Avam Prakrutik Producer Company Ltd.,
Salivaram post, Denkanikottai, Krishnagiri, 
Tamil Nadu - 635107, India
</p>
                                                </div>
                                            </div>
                                        </div>
